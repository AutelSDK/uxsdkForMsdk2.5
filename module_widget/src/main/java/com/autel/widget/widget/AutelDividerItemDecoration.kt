...
class AutelDividerItemDecoration(context: Context, orientation: Int) : RecyclerView.ItemDecoration() {
    ...
    fun setDividerMarginStart(marginStart: Int) {
    ...
    private fun drawVertical(canvas: Canvas, parent: RecyclerView) {
        ...
        if (childCount > 1) {
            for (i in 0 until childCount - 1) {
                ...
                mDivider!!.setBounds(left + dividerMarginStart, top, right, bottom)
